/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: ab63e2b21a43f4d090ca1a4c5dc61348)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	safe_screen_files: R2Bucket;
	safe_screen: D1Database;
	...
	APP_URL: string;
	R2_FILES_ACCOUNT_ID: string;
	R2_FILES_ACCESS_KEY_ID: string;
	R2_FILES_SECRET_ACCESS_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "APP_URL" | "R2_FILES_ACCOUNT_ID" | "R2_FILES_ACCESS_KEY_ID" | "R2_FILES_SECRET_ACCESS_KEY">> {}
}
