/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: e4b25866becba0ba650ad49d4acd6082)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* safe-screen */;
}
